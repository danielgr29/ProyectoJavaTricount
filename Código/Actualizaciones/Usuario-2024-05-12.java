...
public class Usuario{
	...
	public static boolean usuarioExiste(String usuario){	//Consulta la Base de Datos para comprobar si el usaurio existe
		...
		try {
			...
			while (rs.next()) {
				if (rs.getString("nombre").equalsIgnoreCase(usuario)) {	//Comprueba todos las filas de la tabla con el nombre de usaurio pasado por parametro y devuelve true si coinciden
					return true;
				}
			}
			return false;
	...
	public Usuario(String usuario, String contrasenia, String nombreCompleto){
		...
		String sql = "INSERT INTO usuarios VALUES ('" + usuario + "', '" + contrasenia + "', '" + nombreCompleto + "');";
	...
	public String toString() {
		return "Usuario [usuario=" + usuario + ", contrasenia=" + contrasenia + ", nombreCompleto=" + nombreCompleto
				+ "]";
	}
